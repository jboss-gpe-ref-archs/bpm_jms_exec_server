...
... scp -r domain/conf/org 5345d948a99d3d8e8b00001c@bpmsrt-bpmstraining.apps.lab2.opentlc.com:~/app-root/data/appModules/
... scp domain/target/domain-1.0.jar 5345d948a99d3d8e8b00001c@bpmsrt-bpmstraining.apps.lab2.opentlc.com:~/app-root/data/appModules/org/acme/insurance/main/
