...
-----
_https://github.com/jboss-gpe-ref-archs/bpm_jms_exec_server.git_ 
-----

Once successfully cloned, BPM Suite 6 will pop-up a new dialogue box with the message:  _The repository is cloned successfully_
...
. in your local $REF_ARCH_HOME/bpms_jms_exec_server directory, execute:  _git pull remote master_ .  
...
The name of the class is *com.redhat.gpe.refarch.bpm_jms_exec_server.JMSClient*.  
